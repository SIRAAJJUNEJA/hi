...
export const SessionCard: React.FC<SessionCardProps> = ({ session, onJoin, onSelect, onEdit, isAdmin, isExpertiseMatch, reviews }) => {
      ...
      <div className="flex justify-between items-start mb-6 relative z-10">
        ...
        {isAdmin && (
          <button 
            ...
            className="absolute top-4 right-4 p-2 bg-[#1A2238] text-white rounded-full shadow-lg hover:bg-[#7FB5B5] transition-all z-20"
            title="Edit Session"
          >
