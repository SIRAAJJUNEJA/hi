...
export const INITIAL_SESSIONS: Session[] = [
  ...
  {
    id: '3',
    title: 'Y Combinator interview crack guide',
    category: 'Engineering',
    timeLabel: 'LIVE NOW',
    status: 'NOW',
    mentorName: 'Prakhar Sharma',
    mentorInst: 'IIT MADRAS',
    mentorTitle: 'AI',
    mentorBio: 'Prakhar is a scholar at IIT Madras with extensive experience in the startup ecosystem and venture capital networking.',
    avatarUrl: 'https://picsum.photos/seed/prakhar/100/100',
    description: 'A comprehensive guide to navigating the Y Combinator interview process for aspiring founders.',
    longDescription: 'Navigating the Y Combinator interview requires more than just a good product. This session covers the preparation, the common questions, and the mindset needed to crack one of the world\'s most prestigious accelerator programs.',
